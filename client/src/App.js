...
function App() {
  ...
  // book: initial book state that catches input when a user adds a new book (its properties match the ones in the database's Book model)
  ...
  // [handleChange] creates a copy of [book], combines it with the user event input (e), then replaces [book] with the updated version
